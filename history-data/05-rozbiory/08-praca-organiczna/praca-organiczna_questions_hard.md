...
session_end: "2026-05-05T11:15:00Z"
tokens_input: 3500
tokens_output: 3200
tokens_total: 6700
---

# Praca organiczna: Pytania poziom trudny
...
Ruch rozpoczął się najwcześniej w zaborze pruskim, gdzie pionierem był Dezydery Chłapowski (od 1815), a po 1864 rozprzestrzenił się na pozostałe zabory. Kluczową rolę odegrali Karol Marcinkowski, Hipolit Cegielski, August Cieszkowski, Edward Raczyński, ks. Jan Koźmian, Maksymilian Jackowski, Piotr Wawrzyniak oraz Augustyn Szamarzewski.

Wynikami ruchu były powstanie sieci bibliotek ludowych, kółek rolniczych, towarzystw naukowych (Poznańskie Towarzystwo Przyjaciół Nauk, 1857), spółdzielni oraz Spółki Akcyjnej Bazar (1838). W zaborze pruskim umożliwiło to przetrwanie Kulturkampfu i polityki germanizacyjnej (sprawa Michała Drzymały, Niemiecka Komisja Likwidacyjna). Ruch ten stanowił fundament nowoczesnego społeczeństwa obywatelskiego i przygotował grunt pod odrodzenie państwa polskiego w 1918 roku.

---

## Pytanie 1

**Question ID:** Q-RO-PO-H-001
...
**Podsumowanie pliku:**
- Liczba pytań: 3
- Zakres tematyczny: pytania analityczne i syntetyczne wymagające oceny, porównania i analizy złożonych zjawisk historycznych
- Poziom: liceum — zakres rozszerzony
- Umiejętności: analiza porównawcza, ocena z perspektywy historycznej, synteza wieloczynnikowa
- Wszystkie pytania wymagają zrozumienia kontekstu historycznego i umiejętności interpretacji faktów
