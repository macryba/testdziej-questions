...
# Pytania poziom średni - Początki PRL

## Krótki opis historyczny

Początki Polskiej Rzeczypospolitej Ludowej (1945-1956) to okres fundamentalnych przemian politycznych, gospodarczych i społecznych. Po II wojnie światowej Polska znalazła się w strefie wpływów Związku Radzieckiego, co doprowadziło do przejęcia władzy przez komunistów przy wsparciu Armii Czerwonej i NKWD. Proces sowietyzacji objął likwidację opozycji (głównie Polskiego Stronnictwa Ludowego), fałszerstwo wyborcze, nacjonalizację przemysłu, kolektywizację rolnictwa oraz prześladowania Kościoła katolickiego. Okres stalinizmu (1948-1953) przyniósł terror aparatu bezpieczeństwa, procesy pokazowe i całkowite uzależnienie od ZSRR. Śmierć Stalina w 1953 roku oraz strajki robotnicze w Poznaniu w czerwcu 1956 roku stały się punktem zwrotnym, który doprowadził do ograniczonej liberalizacji systemu („odwilż gomułkowska") pod przywództwem Władysława Gomułki.
...
### Pytanie 1
**Question ID:** Q-PRL-POCZATKI-011
...
### Pytanie 2
**Question ID:** Q-PRL-POCZATKI-012
...
**Wyjaśnienie:** Polska utraciła Kresy Wschodnie (tereny obecnej Litwy, Białorusi i Ukrainy) na rzecz ZSRR, ale w zamian otrzymała tzw. Ziemie Odzyskane na zachodzie (Dolny Śląsk, Pomorze Zachodnie, część Brandenburgii i Prus Wschodnich). Nowa granica zachodnia została ustalona na Odrze i Nysie Łużyckiej, co dało Polsce dostęp do morza i nowe miasta (np. Wrocław, Szczecin).
...
### Pytanie 3
**Question ID:** Q-PRL-POCZATKI-013
...
**Wyjaśnienie:** 16 przywódców Polskiego Państwa Podziemnego zostało zaproszonych na rozmowy z dowództwem radzieckim, aresztowanych przez NKWD w marcu 1945 roku i wywiezionych do Moskwy. W tzw. procesie szesnastu (1945) zostali oni skazani na długoletnie więzienie za „działalność szpiegowską i dywersyjną". Był to element rozbijania struktur niepodległościowych przez sowietów.
...
### Pytanie 4
**Question ID:** Q-PRL-POCZATKI-014
...
**Wyjaśnienie:** Komuniści sfałszowali referendum i wybory, ponieważ obawiali się przegranej z Polskim Stronnictwem Ludowym – największą partią opozycyjną. Według raportów nieoficjalnych, na pierwsze pytanie referendum TAK odpowiedziało tylko około 27% głosujących. Fałszerstwa organizowało MBP przy pomocy doradców radzieckich – podmieniano protokoły, wymieniano urny, zastraszano wyborców.
...
### Pytanie 5
**Question ID:** Q-PRL-POCZATKI-015

**Pytanie:** Jaką rolę odegrał Kościół katolicki w okresie stalinizmu (1948-1953) i jaki był stosunek władz do duchowieństwa?
...
**Wyjaśnienie:** Władze komunistyczne traktowały Kościół jako głównego przeciwnika ideologicznego. Aresztowano prymasa Stefana Wyszyńskiego (1953), prześladowano duchowieństwo, konfiskowano majątki kościelne, ograniczano rolę religii w życiu publicznym. Kościół however zachował znaczną wpływ na społeczeństwo i stał się oporem wobec sowietyzacji Polski.
...
### Pytanie 6
**Question ID:** Q-PRL-POCZATKI-016
...
**Wyjaśnienie:** Kolektywizacja polegała na tworzeniu państwowych gospodarstw rolnych (PGR) i zmuszaniu chłopów do wstępowania do spółdzielni produkcyjnych. W przeciwieństwie do ZSRR, w Polsce chłopi nie byli całkowicie pozbawiani ziemi, ale poddawani presji administracyjnej i ekonomicznej (kontyngenty, wysokie podatki). Wiele osób opierało się temu procesowi.
...
### Pytanie 7
**Question ID:** Q-PRL-POCZATKI-017

**Pytanie:** Kto był przewodniczącym Polskiego Komitetu Wyzwolenia Narodowego (PKWN) i pierwszym premierem rządu komunistycznego w Polsce?

**A)** Bolesław Bierut
**B)** Władysław Gomułka
**C)** Edward Osóbka-Morawski
**D)** Józef Cyrankiewicz

**Prawidłowa odpowiedź:** C

**Wyjaśnienie:** Edward Osóbka-Morawski był przewodniczącym PKWN od 22 lipca 1944 roku, a następnie premierem Tymczasowego Rządu Jedności Narodowej (1945-1947). Był on formalnie bezpartyjnym socjalistą, co dawało pozory koalicyjności rządu. W rzeczywistości władza sprawowali komuniści z PPR pod nadzorem radzieckim.
...
### Pytanie 8
**Question ID:** Q-PRL-POCZATKI-018

**Pytanie:** Jakie były główne przyczyny Poznańskiego Czerwca 1956 roku – pierwszego dużego protestu robotniczego w PRL?
...
**Wyjaśnienie:** Bezpośrednią przyczyną protestu były pogorszenie warunków pracy (wyższe normy), niskie płace i brak towarów konsumpcyjnych. Robotnicy zakładów im. Stalina (HCP) i im. Hipolita Cegielskiego w Poznaniu wyszli na ulice żądając „chleba i wolności". Protest miał charakter społeczno-gospodarczy, choć szybko przybrał również wymiar polityczny.
...
### Pytanie 9
**Question ID:** Q-PRL-POCZATKI-019
...
### Pytanie 10
**Question ID:** Q-PRL-POCZATKI-020
...
**Wyjaśnienie:** Armia Czerwona zapewniła komunistom fizyczną kontrolę nad terytorium Polski, likwidując polskie struktury podziemia niepodległościowego (AK, WiN). NKWD aresztowało przywódców Polskiego Państwa Podziemnego, szkoliło funkcjonariuszy UB i doradzało przy fałszowaniu wyborów. Radzieccy doradcy zasiadali we wszystkich kluczowych instytucjach państwowych.
...
### Pytanie 11
**Question ID:** Q-PRL-POCZATKI-021
...
**Wyjaśnienie:** Terror stalinowski obejmował aresztowania (ok. 200 tys. osób), tortury w więzieniach MBP, procesy pokazowe (np. przeciwko „szpiegom i dywersantom" z AK), egzekucje oraz zsyłki do łagrów w ZSRR. Ofiarami byli żołnierze AK, działacze PSL, inteligencja, duchowieństwo i wewnętrzni przeciwnicy Bieruta. Szacuje się, że w latach 1944-1956 stracono ok. 2500 osób z powodów politycznych.
...
### Pytanie 12
**Question ID:** Q-PRL-POCZATKI-022
...
W tym zestawie znajdziesz 12 pytań na poziomie średnim dotyczących Początków PRL (1945-1956). Pytania obejmują przyczyny przejęcia władzy przez komunistów, skutki przemian granic, rolę Armii Czerwonej i NKWD, terror stalinowski, kolektywizację rolnictwa, prześladowania Kościoła oraz Poznański Czerwiec 1956. Pytania są zgodne z podstawą programową liceum (zakres podstawowy) i koncentrują się na analizie przyczyn i skutków wydarzeń historycznych.
